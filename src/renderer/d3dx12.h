...
struct CD3DX12_SUBRESOURCE_FOOTPRINT : public D3D12_SUBRESOURCE_FOOTPRINT
{
  ...
  explicit CD3DX12_SUBRESOURCE_FOOTPRINT(const D3D12_RESOURCE_DESC& resDesc, UINT rowPitch)
  {
    ...
    Depth =
        (resDesc.Dimension == D3D12_RESOURCE_DIMENSION_TEXTURE3D ? resDesc.DepthOrArraySize : 1);
    RowPitch = rowPitch;
  }
};
...
struct CD3DX12_ROOT_PARAMETER1 : public D3D12_ROOT_PARAMETER1
{
  ...
  static inline void
  InitAsConstantBufferView(_Out_ D3D12_ROOT_PARAMETER1& rootParam,
                           UINT                         shaderRegister,
                           UINT                         registerSpace = 0,
                           D3D12_ROOT_DESCRIPTOR_FLAGS  flags = D3D12_ROOT_DESCRIPTOR_FLAG_NONE,
                           D3D12_SHADER_VISIBILITY      visibility = D3D12_SHADER_VISIBILITY_ALL)
  ...
  static inline void
  InitAsShaderResourceView(_Out_ D3D12_ROOT_PARAMETER1& rootParam,
                           UINT                         shaderRegister,
                           UINT                         registerSpace = 0,
                           D3D12_ROOT_DESCRIPTOR_FLAGS  flags = D3D12_ROOT_DESCRIPTOR_FLAG_NONE,
                           D3D12_SHADER_VISIBILITY      visibility = D3D12_SHADER_VISIBILITY_ALL)
  ...
  static inline void
  InitAsUnorderedAccessView(_Out_ D3D12_ROOT_PARAMETER1& rootParam,
                            UINT                         shaderRegister,
                            UINT                         registerSpace = 0,
                            D3D12_ROOT_DESCRIPTOR_FLAGS  flags = D3D12_ROOT_DESCRIPTOR_FLAG_NONE,
                            D3D12_SHADER_VISIBILITY      visibility = D3D12_SHADER_VISIBILITY_ALL)
...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE
{
  ...
  static inline void InitOffsetted(_Out_ D3D12_CPU_DESCRIPTOR_HANDLE& handle,
                                   ...
                                   UINT                                    descriptorIncrementSize)
  {
    handle.ptr = static_cast<SIZE_T>(base.ptr +
                                     INT64(offsetInDescriptors) * UINT64(descriptorIncrementSize));
  }
};
...
struct CD3DX12_GPU_DESCRIPTOR_HANDLE : public D3D12_GPU_DESCRIPTOR_HANDLE
{
  ...
  static inline void InitOffsetted(_Out_ D3D12_GPU_DESCRIPTOR_HANDLE& handle,
                                   ...
                                   UINT                                    descriptorIncrementSize)
  {
    handle.ptr = static_cast<UINT64>(base.ptr +
                                     INT64(offsetInDescriptors) * UINT64(descriptorIncrementSize));
  }
};
